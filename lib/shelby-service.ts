...
type ShelbyNetworkName = "shelbynet";
  ...
  if (APTOS_PRIVATE_KEY) {
    try {
      ...
      const client = new ShelbyClient({
        network: "shelbynet" as ShelbyNetworkName,
        aptos: {
          network: "shelbynet" as ShelbyNetworkName,
      ...
      } as unknown as ConstructorParameters<typeof ShelbyClient>[0]);
      ...
      console.error("❌ Shelby Upload Error:", message);
    }
  }
